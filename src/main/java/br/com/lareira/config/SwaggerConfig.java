...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("br.com.lareira.resource"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API do Projeto de Gestão de Lareiras",
                "Esta API é utilizada para integração do frontend com o backend do projeto de Lareiras",
                "Versão 1.0",
                "https://www.fullcustom.com.br/lareiraterms",
                new Contact("Rodrigo Rossi", "https://linkedin.com/rodrigo-rossi", "rodrigo.rossi@fullcustom.com.br"),
                "Permitido uso apenas para assinantes",
                "https://www.fullcustom.com.br/lareiraterms",
